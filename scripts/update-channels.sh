...
echo -e "channel_sources:\n  - conda-forge,tiledb/label/nightlies,tiledb-shaunreed/label/nightlies" >> "$repo/recipe/conda_build_config.yaml"

# Change upload channel
echo -e "channel_targets:\n  - tiledb-shaunreed nightlies" >> "$repo/recipe/conda_build_config.yaml"
